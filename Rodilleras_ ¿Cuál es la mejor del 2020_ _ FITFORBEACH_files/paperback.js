  ...
  $(document).ready(function() {
    ...
    $(document).keyup(function(e) {
      if (e.keyCode == 27) {
        ...
        $('.featured-posts .grid-thumb')
          .removeClass('fadeInUp')
          .hide();
        $('.featured-posts').removeClass('show');
        $('#site-navigation .current-menu-item').removeClass(
          'current-menu-item'
        );
    ...
    $('.home .hero-wrapper .rslides').each(function() {
      $(this).swipe({
        swipeLeft: function() {
          $(this)
            .parent()
            .find('.rslides_nav.prev')
            .click();
        },
        swipeRight: function() {
          $(this)
            .parent()
            .find('.rslides_nav.next')
            .click();
        }
      });
    });
    ...
    var item = $(
      '<button class="toggle-sub" aria-expanded="false"><i class="fa fa-chevron-down"></i></button>'
    );
    ...
    /**
     * Toggles the categories menu
     */
    $('.js-toggle-categories').on('click', function() {
      $(this).toggleClass('active');
      $('.menu-item:not(".menu-item--categories")').toggleClass('show');
    });
